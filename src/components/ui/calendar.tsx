    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                head_row: "flex",
                head_cell:
                    "text-textSecondary dark:text-textSecondary-dark rounded-md w-9 font-normal text-[0.8rem]",
                ...
                day_outside:
                    "day-outside text-textSecondary dark:text-textSecondary-dark opacity-50 aria-selected:bg-accent/50 aria-selected:text-textSecondary aria-selected:opacity-30",
                day_disabled: "text-textSecondary dark:text-textSecondary-dark opacity-50",
                day_range_middle:
